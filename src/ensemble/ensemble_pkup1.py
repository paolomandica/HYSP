...
joint_path = 'checkpoints/pkummd_joint/linear/score_list.npy'
bone_path = 'checkpoints/pkummd_bone/linear/score_list.npy'
motion_path = 'checkpoints/pkummd_motion/linear/score_list.npy'

label = open('data/pku_part1_frame50/xsub/val_label.pkl', 'rb')
